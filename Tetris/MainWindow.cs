...
namespace Tetris
{
    public partial class MainWindow : Form
    {
        ...
        // Load main window
        public MainWindow(string personal)      
        {
            InitializeComponent();
        ...
        {
            timeElapsed++;
            TimeLabel.Text = "Vreme: " + timeElapsed.ToString();
        }
        ...
        private void UpdateScore()
        {
            ...
            ScoreLabel.Text = "Poeni: " + score.ToString();
        ...
        {
            level++;
            LevelLabel.Text = "Nivo: " + level.ToString();
        ...
        private void AddScoreToTextBox()
        {
            string fulldata = personal + " " + score;
            StreamWriter PersonWriter = new StreamWriter("database.txt", true);
            PersonWriter.WriteLine(fulldata);
            PersonWriter.Close();
            this.Close();
        }
